        ...
        <div className='flex flex-col items-center'>
          ...
          >
            {isDarkMode && location.pathname === '/register' ? (
              <img src='/logo2.png' alt="Записаться на матч" />
            ) : location.pathname === '/register' && !isDarkMode ? (
              <img src='/logo3.png' alt='Записаться на матч' />
            ) : (
              <img src='/logo.png' alt='Записаться на матч' />
            )}
        ...
        <div className='flex flex-col items-center'>
          ...
          >
            ...
            >
              ...
              />
              <path
                d='M6.00137 0.0228177C3.07566 0.205675 1.07566 1.71425 0.332799 4.22853C0.218513 4.60567 0.492799 4.98282 0.88137 4.98282H6.02423C6.34423 4.98286 6.59566 4.73143 6.59566 4.41143V0.594246C6.59566 0.274246 6.32137 -3.9421e-05 6.00137 0.0228177Z'
                fill={
                  location.pathname === '/matches' && !isDarkMode
                    ? '#3D82FF'
                    : location.pathname === '/matches' && isDarkMode
